...
class Maze:    
    ...
    def __setitem__(self, (tup, b), val):
        try:
    ...
    def restore(self, filename=None):
        ...
        given filename.
        """
        j = json.loads(file(filename, 'r').read())
        self.rows = j['rows']
        self.cols = j['cols']
        self.walls = {}
        for x in j['walls']:
