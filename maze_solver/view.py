...
class MazeView:
    ...
    def CELLCENTER(self, (r,c)):
        ...
        return X + int((CELLWIDTH+WALLWIDTH)/2.0) + CELLWIDTH * c, \
           Y + int((CELLWIDTH+WALLWIDTH)/2.0) + CELLWIDTH * r
...
class BotView:
    ...
    def run(self):
        ...
        surface = self.surface
        pygame.draw.circle(surface, self.color, (int(self.p[0]) + self.dx, int(self.p[1]) + self.dy), BOT_RADIUS)
